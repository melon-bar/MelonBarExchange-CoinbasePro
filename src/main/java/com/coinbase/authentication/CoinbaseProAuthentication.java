...
public final class CoinbaseProAuthentication implements Authentication {
     ...
     * Coinbase Pro.
     * <p>
     * Note that this authentication source is implemented for API credentials with <code>Trade</code>
     ...
     * <p>
     * The body is the request body string or omitted if there is no request body (typically for <code>GET</code>
     * requests).
